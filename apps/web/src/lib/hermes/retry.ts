/**
 * Hermes — Retry, timeout, and LLM parsing utilities.
 */
...
/** Safely extract and parse a JSON array from LLM text output. */
export function parseLLMJsonArray<T = any>(text: string): T[] {
