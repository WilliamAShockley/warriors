...
import { Target, BookOpen, Newspaper, Settings, Wand2, Star, LinkIcon, CheckSquare, Bot, FileText, Lightbulb, Footprints, Table2 } from 'lucide-react'
...
const sections = [
  ...
  },
  {
    ...
    label: 'Email Drafts',
    icon: FileText,
    description: 'Reusable email templates you send to founders over and over',
    href: '/email-drafts',
    active: true,
  },
  {
