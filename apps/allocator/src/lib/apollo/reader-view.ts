...
// The reader's view: which of his active theses bear on the company being
// researched, in his own words. Handed to the drafting skill as its own
// labeled block, so a cold email's thesis line comes from what he actually
// thinks — not the voice profile's dated boilerplate.
...
// no theses, no key, or a failed call all return '' and drafting proceeds
// without the block.
