...
STEP 2c — Podcast invitations only. If the to-do invites someone onto the reader's podcast: after gathering context (the Register first, research for what it lacks), call podcast_context_line with the company, the founder, and everything gathered. Take its RECOMMENDED option. Then, whichever playbook drafts in STEP 3, its context MUST carry this instruction: include verbatim, as its own sentence — "I think a ton of people would love to hear more about <the recommended option>, and just in general how you're thinking about the business." No paraphrasing the line.
